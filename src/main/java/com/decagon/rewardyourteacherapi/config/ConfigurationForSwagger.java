...
public class ConfigurationForSwagger implements WebMvcConfigurer {
    ...
    public Docket swaggerConfig() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.decagon.rewardyourteacherapi"))
    ...
    private ApiInfo apiDetails() {
        return new ApiInfo(
                "RewardYourTeacher API",
                "API for RewardYourTeacher",
                "1.0",
                "Free to use",
                new springfox.documentation.service.Contact("", "http://decagonhq.com", "info@decagonhq.com"),
                "API License",
                "",
